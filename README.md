# Collector for Gcf Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-gcf/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-gcf/actions/workflows/run-python-tests.yaml)
 ...
 **hdx-scraper-gcf** as specified in the parameter
 *user_agent_lookup*.
